	...
	<div class="col-xs-12">
		...
		<div class="widget-box">
			...
			<div class="widget-header">
				<h4 class="smaller">表单审批- ${wf.name }</h4>
			</div>
			...
			<form class="form-search">
						...
						<div class="input-group col-xs-12 col-sm-6">
							<div class="col-sm-6">
								...
								<select class="form-control" style="width:160px;" name="status" id="status">
									<option value="等待审批" checked="checked">等待审批</option>
				...
				<div class="form-actions" style="margin-top: 0px; margin-bottom: 0px;background-color: #FFFFE0; padding: 10px 20px 10px;">
					<div class="input-group">
						<button type="button" class="btn btn-warning btn-sm" id="approve">
							<i class="ace-icon fa fa-check-square-o icon-on-right bigger-110"></i> 审批通过
						</button>
...
<script type="text/javascript">
	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			url: "workFlowItemListApproveData.do?wfId=${wf.id}",
	...
	//replace icons with FontAwesome icons like above
											...
											$.ajax({
												...
												success:function(result){
													if(true==result){
														...
														bootbox.alert("表单当前状态不允许执行审批通过操作");
													}
												},		
							...
							$("#attachment").click(function() {
								...
								if (id != null) {
									var rowData = $(grid_selector).jqGrid("getRowData",id);
									window.location.href = "index.do#page/attachmentForViewList.do?id="+rowData.id+"&back=approve";
							...
							$("#detail").click(function() {
								...
								if(id==null) {
									...
									var rowData = $(grid_selector).jqGrid("getRowData",id);
									$(this).attr("href","index.do#page/workFlowItemDetail.do?back=approve&id="+rowData.id);
								}
							});
						});
