					...
					<div id="base" class="tab-pane fade in active">
						<form class="form-horizontal" role="form" id="formid">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-5" class="col-xs-10 col-sm-5" name="go" value="${item.go }"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-7" class="col-xs-10 col-sm-5" name="unitCode" value="${item.unitCode }"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-8" class="col-xs-10 col-sm-5" name="unitName" value="${item.unitName }"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-9" class="col-xs-10 col-sm-5" name="unitType" value="${item.unitType }"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-10" class="col-xs-10 col-sm-5" name="unitIndustry" value="${item.unitIndustry }"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-11" class="col-xs-10 col-sm-5" name="unitArea" value="${item.unitArea }" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-12" class="col-xs-10 col-sm-5" name="unitContacts" value="${item.unitContacts }" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-13" class="col-xs-10 col-sm-5" name="unitTel" value="${item.unitTel }" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-14" class="col-xs-10 col-sm-5" name="type" value="${item.type }"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-15" class="col-xs-10 col-sm-5" name="payment" value="${item.payment }"/> 元/月
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="datepicker" class="col-xs-10 col-sm-5" name="date" value="<fmt:formatDate value="${item.date}" pattern="yyyy-MM-dd"/>" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-16" class="col-xs-10 col-sm-5" name="reason" value="${item.reason }" />
								</div>
							</div>
