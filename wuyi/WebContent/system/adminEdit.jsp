		...
		<!-- PAGE CONTENT BEGINS -->
			...
			<div class="tabbable">
				<ul class="nav nav-tabs" id="myTab">
					<li class="active"><a data-toggle="tab" href="#base"> <i class="green ace-icon fa fa-tags bigger-120"></i> 管理员信息
					</a></li>
				</ul>
					...
					<div id="base" class="tab-pane fade in active">
						<form class="form-horizontal" role="form" id="formid">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-5" class="col-xs-10 col-sm-5" name="tel" value="${user.tel}"/>
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-6"> 电子邮箱 </label>
								<div class="col-sm-9">
									<input type="text" id="form-field-6" class="col-xs-10 col-sm-5" name="mail" value="${user.mail}"/>
								</div>
							</div>
