			...
			<form class="form-search">
				<div class="form-actions" style="margin-top: 0px; margin-bottom: 0px;background-color: #FFFFE0; padding: 10px 20px 10px;">
					<div class="input-group">
						<a class="btn btn-success btn-sm" href="index.do#page/adminAdd">
							<i class="ace-icon fa fa-plus icon-on-right bigger-110"></i> 新增 
						</a>
						<a class="btn btn-success btn-sm" href="index.do#page/adminEdit" id="edit">
...
<script type="text/javascript">
	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			height: 450,
			colNames:['管理员编号', '姓名', '性别', '联系电话','出生年月','电子邮箱'],
			colModel:[
	...
	//replace icons with FontAwesome icons like above
							...
							$("#edit").click(function() {
								...
								if(id==null) {
									...
									var rowData = $(grid_selector).jqGrid("getRowData",id);
									$(this).attr("href","index.do#page/adminEdit.do?userId="+rowData.userId);
								}
							});
						});
