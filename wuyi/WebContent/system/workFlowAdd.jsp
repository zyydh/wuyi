					...
					<div id="base" class="tab-pane fade in active">
						<form class="form-horizontal" role="form" id="formid">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-2" class="col-xs-10 col-sm-5" name="name"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-6" class="col-xs-10 col-sm-5" name="entityName"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-7" class="col-xs-10 col-sm-5" name="addUrl"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-8" class="col-xs-10 col-sm-5" name="updateUrl"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-9" class="col-xs-10 col-sm-5" name="detailUrl"/>
								</div>
							</div>
