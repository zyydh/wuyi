		...
		<!-- PAGE CONTENT BEGINS -->
			...
			<div class="tabbable">
				<ul class="nav nav-tabs" id="myTab">
					<li class="active"><a data-toggle="tab" href="#base"> <i class="green ace-icon fa fa-tags bigger-120"></i> 学生信息
					</a></li>
				</ul>
					...
					<div id="base" class="tab-pane fade in active">
						<form class="form-horizontal" role="form" id="formid">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select id="form-field-4" class="col-xs-10 col-sm-5" name="classesId">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select id="form-field-5" class="col-xs-10 col-sm-5" name="sex" value="${user.sex}">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-9" class="col-xs-10 col-sm-5" name="idcard" value="${user.idcard}"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-10" class="col-xs-10 col-sm-5" name="from" value="${user.from}"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-11" class="col-xs-10 col-sm-5" name="grade" value="${user.grade}"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-12" class="col-xs-10 col-sm-5" name="schoolYear" value="${user.schoolYear}"/>
								</div>
							</div>
								...
								<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a class="btn btn-success btn-sm" href="index.do#page/studentList">
