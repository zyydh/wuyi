					...
					<div id="base" class="tab-pane fade in active">
						<form class="form-horizontal" role="form" id="formid">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="id" value="${classes.id }" readOnly="readOnly"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-2" class="col-xs-10 col-sm-5" name="major" value="${classes.major }"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-3" class="col-xs-10 col-sm-5" name="count" value="${classes.count }"/>
								</div>
							</div>
								...
								<div class="col-sm-9">
									<select id="form-field-4" class="col-xs-10 col-sm-5" name="instructorId">
										<c:forEach items="${teacherList }" var="t">
											<option value="${t.userId}" <c:if test="${classes.instructor.userId==t.userId}">selected="selected"</c:if>>${t.name }</option>
										</c:forEach>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select id="form-field-5" class="col-xs-10 col-sm-5" name="classMentorId">
										<c:forEach items="${teacherList }" var="t">
											<option value="${t.userId}" <c:if test="${classes.classMentor.userId==t.userId}">selected="selected"</c:if>>${t.name }</option>
										</c:forEach>
									</select>
								</div>
							</div>
