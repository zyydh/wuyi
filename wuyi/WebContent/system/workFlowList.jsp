			...
			<form class="form-search">
				<div class="form-actions" style="margin-top: 0px; margin-bottom: 0px;background-color: #FFFFE0; padding: 10px 20px 10px;">
					<div class="input-group">
						<a class="btn btn-success btn-sm" href="index.do#page/workFlowAdd">
							<i class="ace-icon fa fa-plus icon-on-right bigger-110"></i> 新增 
						</a>
						<a class="btn btn-success btn-sm" href="index.do#page/workFlowEdit" id="edit">
						...
						<button type="button" class="btn btn-primary btn-sm" id="template">
							<i class="ace-icon fa fa-arrow-circle-o-down icon-on-right bigger-110"></i> 模板附件
						</button>
					</div>
				</div>
			</form>
...
<script type="text/javascript">
	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			height: 450,
			colNames:['表单编号','表单名称', '检查人', '最终审批人'],
			colModel:[
				{name:'id',index:'id', width:100},
				{name:'name',index:'name', width:300},
				{name:'reviewer',index:'reviewer', width:150},
				{name:'approver',index:'approver', width:150}
			], 
	...
	//replace icons with FontAwesome icons like above
							...
							$("#template").click(function() {
								...
								if (id != null) {
									var rowData = $(grid_selector).jqGrid("getRowData",id);
									window.location.href = "index.do#page/templateList.do?id="+rowData.id+"&name="+rowData.name;
							...
							$("#edit").click(function() {
								...
								if(id==null) {
									...
									var rowData = $(grid_selector).jqGrid("getRowData",id);
									$(this).attr("href","index.do#page/workFlowEdit.do?id="+rowData.id);
								}
							});
						});
