			...
			<form class="form-search">
				<div class="form-actions" style="margin-top: 0px; margin-bottom: 0px;background-color: #FFFFE0; padding: 10px 20px 10px;">
					<div class="input-group">
						<a class="btn btn-success btn-sm" href="index.do#page/studentAdd">
...
<script type="text/javascript">
	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			height: 450,
			colNames:['学号', '姓名', '班级', '年级', '身份证','性别', '联系电话', '电子邮箱', '出生年月','生源地','入学年度'],
			colModel:[
				{name:'userId',index:'userId', width:100},
				{name:'name',index:'name', width:100},
				{name:'classes.id',index:'classes.id', width:100},
				...
				{name:'schoolYear',index:'schoolYear', width:150}
			], 
	...
	//replace icons with FontAwesome icons like above
							...
							$("#edit").click(function() {
								...
								if(id==null) {
									...
									var rowData = $(grid_selector).jqGrid("getRowData",id);
									$(this).attr("href","index.do#page/studentEdit.do?userId="+rowData.userId);
								}
							});
						});
