			...
			<form class="form-search">
				<div class="form-actions" style="margin-top: 0px; margin-bottom: 0px;background-color: #FFFFE0; padding: 10px 20px 10px;">
					<div class="input-group">
						<a class="btn btn-success btn-sm" href="index.do#page/classesAdd">
							<i class="ace-icon fa fa-plus icon-on-right bigger-110"></i> 新增 
						</a>
						<a class="btn btn-success btn-sm" href="index.do#page/classesEdit" id="edit">
...
<script type="text/javascript">
	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			height: 450,
			colNames:['班级编号','所属专业', '人数', '辅导员', '班导师'],
			colModel:[
				{name:'id',index:'id', width:100},
				{name:'major',index:'major', width:100},
				{name:'count',index:'count', width:100},
				{name:'instructor.name',index:'instructor.name', width:150},
				{name:'classMentor.name',index:'classMentor.name', width:150},
			], 
	...
	//replace icons with FontAwesome icons like above
							...
							$("#edit").click(function() {
								...
								if(id==null) {
									...
									var rowData = $(grid_selector).jqGrid("getRowData",id);
									$(this).attr("href","index.do#page/classesEdit.do?id="+rowData.id);
								}
							});
						});
